...
//	KEY(HS_PWR_K, KEY_POWER),
	...
	KEY(HS_0_K, GPIO_KEY_0),
	KEY(HS_1_K, GPIO_KEY_1),
	KEY(HS_2_K, GPIO_KEY_2),
	KEY(HS_3_K, GPIO_KEY_3),
	KEY(HS_4_K, GPIO_KEY_4),
	KEY(HS_5_K, GPIO_KEY_5),
	KEY(HS_6_K, GPIO_KEY_6),
	KEY(HS_7_K, GPIO_KEY_7),
	KEY(HS_8_K, GPIO_KEY_8),
	KEY(HS_9_K, GPIO_KEY_9),
...
//	KEY(HS_WEB_K, GPIO_KEY_WEB),
	...
	KEY(HS_DOT_K, GPIO_KEY_DOT),
	KEY(HS_A_K, GPIO_KEY_A),
	KEY(HS_B_K, GPIO_KEY_B),
	KEY(HS_C_K, GPIO_KEY_C),
	KEY(HS_D_K, GPIO_KEY_D),
	KEY(HS_E_K, GPIO_KEY_E),
	KEY(HS_F_K, GPIO_KEY_F),
	KEY(HS_G_K, GPIO_KEY_G),
	KEY(HS_H_K, GPIO_KEY_H),
	KEY(HS_I_K, GPIO_KEY_I),
	KEY(HS_J_K, GPIO_KEY_J),
	KEY(HS_K_K, GPIO_KEY_K),
	KEY(HS_L_K, GPIO_KEY_L),
	KEY(HS_M_K, GPIO_KEY_M),
	KEY(HS_N_K, GPIO_KEY_N),
	KEY(HS_O_K, GPIO_KEY_O),
	KEY(HS_P_K, GPIO_KEY_P),
	KEY(HS_Q_K, GPIO_KEY_Q),
	KEY(HS_R_K, GPIO_KEY_R),
	KEY(HS_S_K, GPIO_KEY_S),
	KEY(HS_T_K, GPIO_KEY_T),
	KEY(HS_U_K, GPIO_KEY_U),
	KEY(HS_V_K, GPIO_KEY_V),
	KEY(HS_W_K, GPIO_KEY_W),
	KEY(HS_X_K, GPIO_KEY_X),
	KEY(HS_Y_K, GPIO_KEY_Y),
	KEY(HS_Z_K, GPIO_KEY_Z),
	KEY(HS_MENU_K, GPIO_KEY_MENU),
	KEY(HS_HOME_K, GPIO_KEY_HOME),
	KEY(HS_SEARCH_K, GPIO_KEY_SEARCH),
	KEY(HS_RETURN_K, GPIO_KEY_RETURN),
